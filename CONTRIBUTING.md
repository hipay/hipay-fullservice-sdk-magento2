...
- Then, create a Xdebug launch according to your IDE (here is for VSCode) :
  ...
  ```json
  {
    ...
    "port": 9003,
    "pathMappings": {
        "/var/www/html/app/code/HiPay/FullserviceMagento/Api": "${workspaceFolder}/Api",
        "/var/www/html/app/code/HiPay/FullserviceMagento/Block": "${workspaceFolder}/Block",
        "/var/www/html/app/code/HiPay/FullserviceMagento/Controller": "${workspaceFolder}/Controller",
        "/var/www/html/app/code/HiPay/FullserviceMagento/etc": "${workspaceFolder}/etc",
        "/var/www/html/app/code/HiPay/FullserviceMagento/Helper": "${workspaceFolder}/Helper",
        "/var/www/html/app/code/HiPay/FullserviceMagento/Model": "${workspaceFolder}/Model",
        "/var/www/html/app/code/HiPay/FullserviceMagento/Console": "${workspaceFolder}/Console",
        "/var/www/html/app/code/HiPay/FullserviceMagento/Observer": "${workspaceFolder}/Observer",
        "/var/www/html/app/code/HiPay/FullserviceMagento/Plugin": "${workspaceFolder}/Plugin",
        "/var/www/html/app/code/HiPay/FullserviceMagento/Ui": "${workspaceFolder}/Ui",
        "/var/www/html/app/code/HiPay/FullserviceMagento/view": "${workspaceFolder}/view",
        "/var/www/html/app/code/HiPay/FullserviceMagento/Setup": "${workspaceFolder}/Setup",
        "/var/www/html/app/code/HiPay/FullserviceMagento/Cron": "${workspaceFolder}/Cron",
        "/var/www/html/app/code/HiPay/FullserviceMagento/i18n": "${workspaceFolder}/i18n",
        "/var/www/html/app/code/HiPay/FullserviceMagento/Logger": "${workspaceFolder}/Logger",
        "/var/www/html/app/code/HiPay/FullserviceMagento/Test": "${workspaceFolder}/Test",
        "/var/www/html/app/code/HiPay/FullserviceMagento/composer.json": "${workspaceFolder}/composer.json",
        "/var/www/html/app/code/HiPay/FullserviceMagento/registration.php": "${workspaceFolder}/registration.php",
        "/var/www/html/tests": "${workspaceFolder}/tests",
        "/var/www/html/var/log": "${workspaceFolder}/log",
        "/var/www/html/sdk": "${workspaceFolder}/conf/sdk",
