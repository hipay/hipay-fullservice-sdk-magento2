...
namespace HiPay\FullserviceMagento\Model\Rule;

use Magento\Rule\Model\Condition\AbstractCondition as BaseCondition;

abstract class AbstractCondition extends BaseCondition {
