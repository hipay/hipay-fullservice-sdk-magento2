...
define([
  ...
  return Component.extend({
    ...
    initHiPayConfiguration: function (initCallback) {
      ...
      if (self.locale && self.locale.length > 2) {
    ...
    getDisplayCardOwner: function () {
      return window.checkoutConfig.payment.hiPayFullservice.displayCardOwner[
        this.getCode()
      ];
    },
    getCcAvailableTypes: function () {
      return window.checkoutConfig.payment.ccform.availableTypes[
        this.getCode()
      ];
    },
    ...
    hasVerification: function () {
      return window.checkoutConfig.payment.ccform.hasVerification[
        this.getCode()
      ];
    },
      ...
      return [
        {
          ...
          value: this.getCcTypeTitleByCode(this.creditCardType())
        },
        {
          name: 'Credit Card Number',
          value: this.formatDisplayCcNumber(this.creditCardNumber())
        }
      ];
    }
  });
