...
define([
  ...
  rendererList.push(
    ...
    {
      type: 'hipay_bancomatpay_hosted_fields',
      component:
    ...
    {
      type: 'hipay_klarna_hosted_fields',
      component:
      'HiPay_FullserviceMagento/js/view/payment/method-renderer/hipay-klarna-hosted-fields'
    }
  );
  /**
