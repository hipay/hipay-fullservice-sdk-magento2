  ...
  return Component.extend({
    defaults: {
      ...
      afterPlaceOrderUrl:
        window.checkoutConfig.payment.hiPayFullservice.afterPlaceOrderUrl
          .hipay_bizum_hosted_fields,
      template:
        'HiPay_FullserviceMagento/payment/hipay-bizum-hosted-fields',
      env: window.checkoutConfig.payment.hipay_bizum_hosted_fields
        ? window.checkoutConfig.payment.hipay_bizum_hosted_fields.env
        : 'stage',
      apiUsernameTokenJs: window.checkoutConfig.payment
        .hipay_bizum_hosted_fields
        ? window.checkoutConfig.payment.hipay_bizum_hosted_fields
            .apiUsernameTokenJs
        : '',
    ...
    initTOCEvents: function () {
      ...
      $(document).ready(function () {
        ...
        function initBizumEvents() {
          var results = document.querySelectorAll(
            "input[id*='agreement_hipay_bizum']"
          );
    ...
    getBizumInformativeMessage: function () {
      return $.mage.__(
        'The payment will have to be validated on your Bizum application.'
      );
    },
    ...
    getCode: function () {
      return 'hipay_bizum_hosted_fields';
    },
