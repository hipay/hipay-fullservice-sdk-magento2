...
define([
  ...
  return Component.extend({
    defaults: {
      ...
      env: window.checkoutConfig.payment.hipay_sisal_hosted_fields
        ? window.checkoutConfig.payment.hipay_sisal_hosted_fields.env
        : 'stage',
      apiUsernameTokenJs: window.checkoutConfig.payment
        .hipay_sisal_hosted_fields
        ? window.checkoutConfig.payment.hipay_sisal_hosted_fields
            .apiUsernameTokenJs
        : '',
    ...
    initHostedFields: function () {
      ...
      self.hipayHostedFields = self.hipaySdk.create('sisal', self.configHipay);
    ...
    getCode: function () {
      return 'hipay_sisal_hosted_fields';
    },
    getData: function () {
      var self = this;
