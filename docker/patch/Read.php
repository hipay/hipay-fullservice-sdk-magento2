...
class Read implements ReadInterface
{
    ...
    public function readFile($path, $flag = null, $context = null)
    {
        ...
        if(strpos($absolutePath,"home/magento2") !== false){
        	$absolutePath = str_replace("home/magento2/hipay-fullservice-sdk-magento2/src","vendor/hipay/hipay-fullservice-sdk-magento2",$absolutePath);
        }
