...
casper.test.begin('Parameters', function (test) {
  ...
  test.on('fail', function () {
    ...
    test.comment(
      "Image 'fail" + img + ".png' captured into '" + pathErrors + "'"
    );
    casper.echo(
      'Tests réussis : ' + test.currentSuite.passes.length,
      'WARNING'
    );
  });
  ...
  casper.options.viewportSize = {
    width: defaultViewPortSizes['width'],
    height: defaultViewPortSizes['height']
  };
