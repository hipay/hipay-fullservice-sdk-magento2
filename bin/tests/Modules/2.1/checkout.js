    ...
    casper.then(
        function () {
            ...
            this.waitForSelector(
                'ol.widget-product-grid>li:first-of-type img', function success()
                {
...
exports.addItemGoCheckout = function addItemGoCheckout(test)
{
    casper.then(
        function () {
            ...
            this.waitForSelector(
                "#product-addtocart-button", function success()
                {
                    this.wait(
                        1000, function () {
            ...
            this.then(
                function () {
                    this.waitUntilVisible(
                        '#top-cart-btn-checkout', function () {
            ...
            this.then(
                function () {
                    this.waitForSelector(
                        "#shipping-method-buttons-container", function success()
                        {
...
exports.billingInformation = function billingInformation(test, country)
{
    casper.then(
        function () {
            ...
            this.waitForSelector(
                "form#co-shipping-form", function success()
                {
...
exports.shippingMethod = function shippingMethod(test)
{
    casper.then(
        function () {
            ...
            this.waitUntilVisible(
                'input#s_method_flatrate_flatrate', function success()
                {
...
exports.choosingPaymentMethod = function (test, method_hipay) {
    casper.then(
        function () {
            ...
            this.waitUntilVisible(
                '#checkout-step-payment input#' + method_hipay, function success()
                {
                    this.click('input#' + method_hipay);
                    test.info("Done");
                }, function fail()
