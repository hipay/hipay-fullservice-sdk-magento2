...
class CcMethod extends FullserviceMethod
{
     ...
     * @throws LocalizedException
     */
    public function saveCard(array $cardData, int $customerId)
    {
        try {
            // Format card name
     ...
     * @return Card|null
     */
    private function findExistingCard(int $customerId, string $ccNumberEnc)
    {
     ...
     * @return string
     */
    private function formatCardName(array $cardData)
    {
        return sprintf(
            '%s •••• %s - Expires %s/%s',
