 ...
 *
 * @author    PI Ecommerce <pi-ecommerce@hipay.com>
 * @copyright Copyright (c) 2016 - HiPay
 * @license   http://www.apache.org/licenses/LICENSE-2.0 Apache 2.0 Licence
...
abstract class AbstractConfigProvider
{
    ...
    protected function resolveValidStoreId()
    {
        try {
            ...
            $this->logger->warning(static::class . ' : Unable to resolve store ID from quote', [
        ...
        try {
            ...
            $this->logger->warning(static::class . ' : Unable to resolve store ID from store manager', [
                'exception' => $e->getMessage()
            ]);
        }
        return 1;
